...
class ContactHelper:
    ...
    def get_contact_info_from_edit_page(self,index):
        ...
        return Contact(firstname=firstname, lastname=lastname, homephone=homephone,id=id,
    ...
    def get_contact_from_view_page(self,index):
        ...
        return Contact(homephone=homephone, id=id,
                       workphone=workphone, mobilephone=mobilephone) # только телефоны
